...
public class CBDD {
    ...
    public CBDD() {
        this.parametresStockageBDD = new CParametresStockageBDD();
         try {
    ...
    public static void main(String[] args) {
      ...
      CBDD bdd = new CBDD(new CParametresStockageBDD("parametresBdd.properties")); //cl Ajouté  
        
        
    }

    /**
     * @return the parametresStockageBDD
     */
